    ...
    <div class="card-body">
        <form method="POST" action="<?= base_url('admin/lokasi_presensi/update/' . $lokasi_presensi['id']) ?>">
            ...
            <div class="input-style-1">
                ...
                <textarea name="alamat_lokasi" cols="30" rows="5" placeholder="Alamat Lokasi" class="form-control <?= ($validation->hasError('alamat_lokasi')) ? 'is-invalid' : '' ?>"><?= $lokasi_presensi['alamat_lokasi'] ?></textarea>
            ...
            <div class="input-style-1">
                ...
                <input type="time" value="<?= $lokasi_presensi['jam_masuk'] ?>" class="form-control <?= ($validation->hasError('jam_masuk')) ? 'is-invalid' : '' ?>" name="jam_masuk" />
                <div class="invalid-feedback"><?= $validation->getError('jam_masuk') ?></div>
            </div>
            <div class="input-style-1">
                <label>Jam Pulang</label>
                <input type="time" value="<?= $lokasi_presensi['jam_pulang'] ?>" class="form-control <?= ($validation->hasError('jam_pulang')) ? 'is-invalid' : '' ?>" name="jam_pulang" />
